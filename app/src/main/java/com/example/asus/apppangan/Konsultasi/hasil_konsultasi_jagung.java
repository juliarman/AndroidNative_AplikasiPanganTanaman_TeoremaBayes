...
import com.example.asus.apppangan.Penyakit.detail_penyakit_jagung;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

public class hasil_konsultasi_jagung extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       int i;
        ...
        setContentView((int) R.layout.activity_hasil_konsultasi_jagung);
        ...
        this.cursor1 = db.rawQuery("SELECT p.namapenyakit from rulejagung r inner join penyakitjagung p on r.id_penyakit = p.id_penyakit inner join gejalajagung g on r.id_gejala = g.id_gejala where g.namagejala in (" + getIntent().getStringExtra("namagejala") + ") group by p.namapenyakit order by namapenyakit ASC", null);
    ...
    public void prosesajagung(View view) {
        ...
        Intent i = new Intent(this, detail_penyakit_jagung.class);
