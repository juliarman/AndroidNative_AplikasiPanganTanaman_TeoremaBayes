...
public class konsultasipenyakit_gejala_jagung extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_konsultasipenyakit_gejala_jagung);


        this.listgejalanya = (ListView) findViewById(R.id.listviewnya_gejalaa);
        this.databasena = new DBHelper(this);
        this.cursor = this.databasena.getReadableDatabase().rawQuery("SELECT * FROM gejalajagung ORDER BY id_gejala ASC", null);
    ...
    public void  prosesnajagung(View view) {
        ...
        Intent hasiljagung = new Intent(this, hasil_konsultasi_jagung.class);
        hasiljagung.putExtra("namagejala", namagejala);
        if (namagejala == "") {
            Toast.makeText(this, "Pastikan anda sudah memilih satu atau lebih gejala !", 1).show();
        } else {
            startActivity(hasiljagung);
        }
    }
}
